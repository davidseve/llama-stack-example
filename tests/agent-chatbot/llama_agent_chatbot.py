...
Your goal is to be as helpful as possible while leveraging all available tools effectively."""
    ...
    def test_kubernetes_query(self):
        ...
        test_query = "Can you list the pods in the openshift-gitops namespace? If you cannot access that namespace, try to list namespaces or check your current Kubernetes configuration. From the list tell me what does each pod is use for"
